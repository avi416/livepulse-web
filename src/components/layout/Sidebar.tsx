...
import { Search, Home, Compass, Users, PlusSquare, Tv, User, MoreHorizontal } from 'lucide-react';
...
export default function Sidebar() {
  ...
  <nav className="nav">
      ...
      <div className="mt-6">
        <button className="w-full px-4 py-2 rounded-md bg-[var(--primary)] text-white font-medium">Log in</button>
      </div>
    </aside>
  );
}
